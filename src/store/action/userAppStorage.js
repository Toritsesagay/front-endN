...
export const signup = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      const response = await fetch(`https://back-endn.onrender.com/signup`, {
        method: "POST",
        headers: {
...
export const login = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      const response = await fetch('https://back-endn.onrender.com/login', {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const verifiedEmail = (data) => {
  return async (dispatch, getState) => {
    try {
      const response = await fetch(`https://back-endn.onrender.com/emailverify`, {
        headers: {
          "Content-Type": "application/json",
        },
        body: JSON.stringify(data)
...
//https://back-endn.onrender.com.com
...
export const checkverification = (email) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://back-endn.onrender.com/checkverification/${email}`, {
        headers: {
          "Content-Type": "application/json",
        }
      })
...
export const verifying = (token) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://back-endn.onrender.com/verifying/${token}`, {
        headers: {
          "Content-Type": "application/json",
        }
      })
...
export const sendRecoverEmail = (data) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://back-endn.onrender.com/recoverpassword`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const checkRecoverTokenValidity = (token) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://back-endn.onrender.com/checkrecovertokenvalidity/${token}`, {
        headers: {
          "Content-Type": "application/json",
        }
      })
...
export const changePassword = (data) => {
  return async (dispatch, getState) => {
    //do some check on the server if its actually login before proceding to dispatch
    try {
      const response = await fetch(`https://back-endn.onrender.com/changepassword/${data.token}`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const phoneSignup = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/phonesignup/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const verifyPhone = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/verifyphone/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const registeration = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/registeration/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const profilePhoto = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/pofilephoto/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
        },
        method: 'POST',
...
export const hasCardFun = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/hascard/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        }
...
export const createCard = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/createcard/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const deleteCard = (id) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/deletecard/${userToken}/${id}`, {
        method: 'DELETE',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const fetchDeposits = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/withdraws/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        }
...
export const createDeposits = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/deposits/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const withdraws = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/withdraw/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const fetchAccounts = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/accounts/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        }
...
export const submitTaxCode = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/tax/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const submitBsaCode = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/bsa/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const submitTacCode = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/tac/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const submitNrcCode = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/nrc/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const submitImfCode = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/imf/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const submitCotCode = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/cot/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const sendAccount = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/sendAccount/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const sendAccountWithinBank = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/sendAccountWithinBank/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const fetchTransfersAccount = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/transferstoaccount/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        },
...
export const fetchAllAccount = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/allaccounts/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        },
...
export const sendOtpCode = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/otpcode/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        }
...
export const fetchAllBenefeciaries = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/beneficiaries/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        }
...
export const fetchAllNotifications = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/notifications/${userToken}`, {
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
        }
...
export const deleteNotification = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/notifications/${userToken}/${data._id}`, {
        method: 'DELETE',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const applyLoan = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/loan/${userToken}`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const fetchAdmin = () => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/admin`, {
        method: 'GET',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
...
export const sendContactEmail = (data) => {
  return async (dispatch, getState) => {
    ...
    try {
      ...
      const response = await fetch(`https://back-endn.onrender.com/contact`, {
        method: 'POST',
        headers: {
          "Content-Type": "application/json",
          "header": `${userToken}`
